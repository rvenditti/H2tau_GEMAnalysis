...
#ifndef VHAnalyser_Jan13_h
#define VHAnalyser_Jan13_h
...
public :
 ...
 TH1*	 hMuonPtWP2012;
   ...
   TH2* MtMuTauVSMET_afterZ;
    ...
    TH1*  	hTauPtAfterTau;
    TH1*	hTauEtaAfterTau;
    TH1*	hTauOSPt_AfterIso;
    TH1*	hTauSSPt_AfterIso;
 ...
 Int_t           Tau_NumChHad[kMaxTau];   //[Tau_]
   ...
   VHAnalyser_Jan13(TTree *tree , std::string fname);
   virtual ~VHAnalyser_Jan13();
...
#ifdef VHAnalyser_Jan13_cxx
VHAnalyser_Jan13::VHAnalyser_Jan13(TTree *tree,std::string fname)  
{
...
VHAnalyser_Jan13::~VHAnalyser_Jan13()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t VHAnalyser_Jan13::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VHAnalyser_Jan13::LoadTree(Long64_t entry)
{
...
void VHAnalyser_Jan13::Init(TTree *tree)
{
...
Bool_t VHAnalyser_Jan13::Notify()
{
...
void VHAnalyser_Jan13::Show(Long64_t entry)
{
...
Int_t VHAnalyser_Jan13::Cut(Long64_t entry)
{
...
#endif // #ifdef VHAnalyser_Jan13_cxx
