...
#	echo $count
	if ($count % $files_per_job == 0) then
	 rm -f histograms_MC_VBFH2Tau_PU50woGEM_2015_ProvaAnalisi$filenum.C
         ...
         rm -f fileinp_$filenum
         sed s/histo_file_VBFH2Tau_PU50woGEM_2015_ProvaAnalisiXX/histo_file_VBFH2Tau_PU50woGEM_2015_ProvaAnalisi$filenum/ jobs2_$filenum >> histograms_MC_VBFH2Tau_PU50woGEM_2015_ProvaAnalisi$filenum.C
         rm -f jobs2_$filenum
