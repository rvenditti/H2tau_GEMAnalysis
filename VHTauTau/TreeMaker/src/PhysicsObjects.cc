...
vhtm::Tau::Tau():
  ...
  byLooseCombinedIsolationRhoCorr3Hits(-1),
  byMediumCombinedIsolationRhoCorr3Hits(-1),
  byTightCombinedIsolationRhoCorr3Hits(-1),
  byCombinedIsolationRhoCorrRaw3Hits(-1),
...
vhtm::Muon::Muon() :
  ...
  sumNeHadR03(-999),
  sumPhEtR03(-999),
  sumNeHadEtHighThresholdR03(-999),
  sumPhEtHighThresholdR03(-999),
  sumPUR03(-999),  
  sumChHadR04(-999),
  sumChPartR04(-999),
  sumNeHadR04(-999),
  sumPhEtR04(-999),
  sumNeHadEtHighThresholdR04(-999), 
  sumPhEtHighThresholdR04(-999),
  sumPUR04(-999),
