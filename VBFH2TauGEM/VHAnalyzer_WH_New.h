...
#ifndef VHAnalyzer_WH_New_h
#define VHAnalyzer_WH_New_h
...
public :
  ...
  void saveHistograms();
   ...
   TH1* 	hMuonEtaFinal_HE;
   TH1* 	hMuonPtFinal_HE; 
   TH1* 	hMuonEtaFinal_Barrel;
   TH1* 	hMuonPtFinal_Barrel ;
   TH1* 	hMuonEtaFinal_Full ;
   TH1* 	hMuonPtFinal_Full  ;
   TH1* 	hMuonPtWP2012 ;
   ...
   TH1* 	hDBerr_Barrel;
	...
	TH1* mupt_gen;
	TH1*  VertexSS;
	TH1* MuTau1_AfterTau1;
	TH1* MuMET_AfterTau1;
	TH1* Tau1Pt_AfterTau1;
	TH1* MuPt_AfterTau1;
	TH2* MtMuMetVsMet_afterCharge;
	TH1*  MaxPtGreat25;
	TH1*   sizeTauOS;
	TH1*   sizeTauSS;
	TH1*   hBDT_Fake;
	...
	TH1*  	  h_mva2d;
	TH1* 	hOneJet;
    TH2*  MtMuMetVsMet_afterZ;
    TH2* MtMuTauVSMET_afterCharge;
    TH2* MtMuTauVSMET_afterZ;
    TH2* cosTauLeadVSMtMuMet_afterCharge;
    TH2* cosTauSubVSMtMuMet_afterCharge;
    TH2* cosTauLeadVSMtMuMet_afterZ;
    TH2* cosTauSubVSMtMuMet_afterZ;
    
    TH1* cosTauLeadVSMet_afterCharge;
    TH1*  cosTauSubVSMet_afterCharge;
    TH1*  cosTauSubVSMet_afterZ;
    TH1*  cosTauLeadVSMet_afterZ;
    ...
    TH1*  mass_MuMet_PU;
    TH1*  mass_MuTau1_PU;
    TH1*  mass_TauTau_SS_PU;
    TH1* sizeMuonMatchStat;
    TH1* sizeTau1DR;
    TH1* sizeTau1AgMu;
    TH1* sizeTau2AgMu;
    TH1* sizeMuonPt;
    TH1* sizeMuonChambers;
    TH1*  sizeTau2DRTau1;
    TH1*   sizeTau2DRMu;
    TH1*            hNPU;
    TH1*            hNPU_PU;
    ...
    TH1*            sizeMuonID;
    TH1*            sizeMuonAccept;
    TH1*            sizeTauAgainstLepton1;
    TH1*            sizeTauISO1;
    TH1*            sizeTauDeltaZ1;
    TH1*            sizeTauID1;
    TH1*            sizeTauAccept1;
    TH1*            sizeTauPt1;
    TH1*            sizeTauAgainstLepton2;
    TH1*            sizeTauISO2;
    TH1*            sizeTauDeltaZ2;
    TH1*            sizeTauID2;
    TH1*            sizeTauAccept2;
    ...
    TH1*            hMuonEtaReco;
    TH1*            hPtEle;
    TH1*            nEle_baseSelection;
    TH1*            nTau_baseSelection1;
    TH1*            nTau_baseSelection2;
    TH1*            hTau_jetEta;
    TH1*            hTau_deltaZ1;
    TH1*            hTau_deltaZ2;
    TH1*            hPtJet;
    TH1*            hJettrackCountingHighEffBTag;
    TH1*            hPtJet_baseSelection;
    TH1*            nJet_baseSelection;
    TH1*            sizeJetMatch;
    TH1*            hWH_Pt;
    TH1*            hTau1Pt_ottimizzazione;
    TH1*            hTau2Pt_ottimizzazione;
    
    
    
    TH1*	  sizeMuonTrackGlob;
    TH1* 	  sizeMuonPixHits;
    TH1* 	  sizeMuonTrackHits;
    TH1* 	  sizeMuonChi2;
    TH1* 	  sizeMuondB;
    TH1* 	  sizeMuonDistZ;
    TH1* 	  sizeMuonNMatch;
 ...
 TH1*  hVBFTag;
    ...
    TH1*    GTFLEvent;
    TH1*    initial_entries;
    TH1*    entries_after_vertex;
    TH1*    entries_after_vertex_PU;
    TH1*	sizeAfterTrigger_PU;
    TH1* 	sizeAfterTrigger;
    TH1*    MuonMatchEvent;
    TH1*    TauMatchEvent;
    TH1*    JetMatchEvent;
    TH1*    sizeTauZDist;
    ...
    TH1*    hMuon2Pt[8];
    TH1*    hMuon2Eta[8];
    TH1*    massainv_TauTau[8];
    TH1*    hdB_err[8];
    TH1*    muondB[8];
    
    TH1*    mass_Mu1Mu2_jtotau1;
    TH1*    mass_Mu1Tau1_jtotau1;
    TH1*    mass_Mu2Tau1_jtotau1;
    TH1*    mass_Mu1Tau2_jtotau1;
    TH1*    mass_Mu2Tau2_jtotau1;
    TH1*    hTau1Eta_jtotau1;
    TH1*    hTau1Pt_jtotau1;
    TH1*    hTau2Eta_jtotau1;
    TH1*    hTau2Pt_jtotau1;
    TH1*    hMuon1Pt_jtotau1;
    TH1*    hMuon1Eta_jtotau1;
    TH1*    hMuon2Pt_jtotau1;
    TH1*    hMuon2Eta_jtotau1;
    TH1*    massainv_TauTau_jtotau1;
    TH1*    tagli_7_jtotau1;
    TH1*    mass_Mu1Mu2_jtotau2;
    TH1*    mass_Mu1Tau1_jtotau2;
    TH1*    mass_Mu2Tau1_jtotau2;
    TH1*    mass_Mu1Tau2_jtotau2;
    TH1*    mass_Mu2Tau2_jtotau2;
    TH1*    hTau1Eta_jtotau2;
    TH1*    hTau1Pt_jtotau2;
    TH1*    hTau2Eta_jtotau2;
    TH1*    hTau2Pt_jtotau2;
    TH1*    hMuon1Pt_jtotau2;
    TH1*    hMuon1Eta_jtotau2;
    TH1*    hMuon2Pt_jtotau2;
    TH1*    hMuon2Eta_jtotau2;
    TH1*    massainv_TauTau_jtotau2;
    TH1*    tagli_7_jtotau2;
    TH1*    mass_Mu1Mu2_DC;
    TH1*    mass_Mu1Tau1_DC;
    TH1*    mass_Mu2Tau1_DC;
    ...
    TH2* MuTauVSHPt;
    TH1* NoExtraMuon;
    TH1* bdiscrAleternative;
    TH1* bdiscrAleternativeAfter;
    TH1* sizeMuTau1Z;
    ...
    TH1*    hMuonPt_PU[8];
    TH1*    hMuonEta_PU[8];
    TH1*    massainv_TauTau_PU[8];
    TH1*    hdB_err_PU[8];
    TH1*    muondB_PU[8];
    
    TH1*    hmassa_trasversa;
    TH1*    deltaPhi_muMET;
    TH1*    hPt_ratio;
    TH1*    hPt_ratio_PU;
    TH1*    hPt_ratio_Final;
    TH1*    hPt_ratio_Final_PU;
    TH1* sizeMtmumet;
 ...
 Int_t           Tau_NumChHad[kMaxTau];   //[Tau_]
   ...
   VHAnalyzer_WH_New(TTree *tree , std::string fname);
   virtual ~VHAnalyzer_WH_New();
...
#ifdef VHAnalyzer_WH_New_cxx
VHAnalyzer_WH_New::VHAnalyzer_WH_New(TTree *tree,std::string fname)  
{
...
VHAnalyzer_WH_New::~VHAnalyzer_WH_New()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t VHAnalyzer_WH_New::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VHAnalyzer_WH_New::LoadTree(Long64_t entry)
{
...
void VHAnalyzer_WH_New::Init(TTree *tree)
{
...
Bool_t VHAnalyzer_WH_New::Notify()
{
...
void VHAnalyzer_WH_New::Show(Long64_t entry)
{
...
Int_t VHAnalyzer_WH_New::Cut(Long64_t entry)
{
...
#endif // #ifdef VHAnalyzer_WH_New_cxx
