1. create the input tree list with getfiles.sh, as indicated in the following example: 
./getfiles.sh /lustre/cms/store/user/rosma/SamplePh2/VBF_HToTauTau_M-125_14TeV_GEM2019Upg14DR-PU50/ >& list.txt

2.create the *.C files with the TChain input and output file name with:
./test_script_3.sh
