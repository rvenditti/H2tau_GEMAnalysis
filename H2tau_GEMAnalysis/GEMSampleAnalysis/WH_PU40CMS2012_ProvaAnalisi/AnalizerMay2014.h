...
// Mon May 19 16:10:45 2014 by ROOT version 5.34/10
// from TTree vhtree/VH Analysis Tree
// found on file: /lustre/cms/store/user/rosma/TauIsoUpgrade/WH_ZH_HToMuMu_M-125_13TeV_PU40bx25_2/tree_18_1_xHn.root
//////////////////////////////////////////////////////////

#ifndef AnalizerMay2014_h
#define AnalizerMay2014_h
...
const Int_t kMaxVertex = 58;
const Int_t kMaxGenParticle = 2103;
...
const Int_t kMaxTau = 63;

class AnalizerMay2014 {
public :
   ...
   AnalizerMay2014(TTree *tree=0);
   virtual ~AnalizerMay2014();
...
#ifdef AnalizerMay2014_cxx
AnalizerMay2014::AnalizerMay2014(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lustre/cms/store/user/rosma/TauIsoUpgrade/WH_ZH_HToMuMu_M-125_13TeV_PU40bx25_2/tree_18_1_xHn.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lustre/cms/store/user/rosma/TauIsoUpgrade/WH_ZH_HToMuMu_M-125_13TeV_PU40bx25_2/tree_18_1_xHn.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lustre/cms/store/user/rosma/TauIsoUpgrade/WH_ZH_HToMuMu_M-125_13TeV_PU40bx25_2/tree_18_1_xHn.root:/treeCreator");
...
AnalizerMay2014::~AnalizerMay2014()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AnalizerMay2014::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalizerMay2014::LoadTree(Long64_t entry)
{
...
void AnalizerMay2014::Init(TTree *tree)
{
...
void AnalizerMay2014::Show(Long64_t entry)
{
...
Int_t AnalizerMay2014::Cut(Long64_t entry)
{
...
#endif // #ifdef AnalizerMay2014_cxx
