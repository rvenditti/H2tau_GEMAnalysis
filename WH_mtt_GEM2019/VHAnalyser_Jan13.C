...
void VHAnalyser_Jan13::Loop()
{
   ...
   for (Long64_t jentry=0; jentry<100000;jentry++) {
      ...
      // if (Cut(ientry) < 0) continue;
       ...
       ///////////////////////////////mu tau_h tau_h selection at gen level
       ...
       /////////////////////////////////////////////////////////////////////////////////////////////////////
       /////////////fully hadronic final state selection
 ...
 MET.SetPtEtaPhiM(mvaMET_met[0], 0., mvaMET_metphi[0], 0.);
	 ...
	 if(! ( (Muon_sumChPartR04[i] /Muon_pt[i]) <0.1 ) ) continue;  //use charged iso only
