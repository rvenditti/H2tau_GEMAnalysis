...
namespace vhtm {
 ...
 class RhoNeutral: public TObject {
  public:
    RhoNeutral();
    ~RhoNeutral() {}

    double rhoNeutral;
    ClassDef(RhoNeutral,1) 
      };
 ...
 float  pfElectronMVA;        
  ...
  float byLooseCombinedIsolationRhoCorr3Hits;
  float  byMediumCombinedIsolationRhoCorr3Hits;
  float  byTightCombinedIsolationRhoCorr3Hits;
  float  byCombinedIsolationRhoCorrRaw3Hits;            
  ...
  public:
    ...
    float sumNeHadR03;
    float sumPhEtR03;
    float sumNeHadEtHighThresholdR03;
    float sumPhEtHighThresholdR03;
    float sumPUR03;
    float sumChHadR04;
    float sumChPartR04;
    float sumNeHadR04;
    float sumPhEtR04;
    float sumNeHadEtHighThresholdR04; 
    float sumPhEtHighThresholdR04;
    float sumPUR04;
